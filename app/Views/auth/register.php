...
<div class="card card-outline card-danger mt-4 mx-4">
    ...
    <div class="card-body">
        <p class="login-box-msg"><b>Kila box litagharimu <?= $kont['price'] ?> SAR</b></p>
        ...
        <?= form_open('register') ?>
                ...
                <div class="col-md-6 mb-1">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select rounded-0" name="nchi" value="<?= old('nchi') ?>">
                            <option selected disabled>Chagua Unapotoka</option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                        <select name="jamia" class="custom-select">
                            ...
                            <option value="OTHERS">Jamia Nyengine</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6 mb-1">
            ...
            <input type="hidden" name="amount" value="<?= $kont['price'] ?>">
            <button type="submit" class="btn btn-block btn-success btn-lg mt-2">Sajili kusafirisha </button>
        </form>
    </div>
<?= $this->endSection() ?>