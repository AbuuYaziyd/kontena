...
<div class="card card-outline card-danger mt-4 mx-4 col-5">
    <div class="card-header text-center">
        <a href="<?= base_url() ?>" class="h1"><b><?= $title ?></b> <span class="btn btn-danger float-right"><b><?= $kont['price'] ?>SAR</b></span></a>
    </div>
    <div class="card-body">
